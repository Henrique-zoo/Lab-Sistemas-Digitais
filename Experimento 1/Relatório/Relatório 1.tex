...
\begin{figure}[H]
    \centering
    \include{Recursos/Circuitos/q1a}
    \vspace{-30pt}
...
\begin{figure}[H]
    \centering
    \include{Recursos/Circuitos/q1b}
    \vspace{-30pt}
...
\begin{figure}[H]
    \centering
    \include{Recursos/Circuitos/q2a}
    \vspace{-30pt}
...
\begin{figure}[H]
    \centering
    \include{Recursos/Circuitos/q2b}
    \vspace{-30pt}
...
\begin{table}[H]
    ...
    \begin{tabular}{|>{\centering\arraybackslash}m{0.2\textwidth}|>{\centering\arraybackslash}m{0.6\textwidth}|}
        ...
        NOT & \include{Recursos/Circuitos/NOTcomNAND} \\ \hline
        AND & \include{Recursos/Circuitos/ANDcomNAND} \\ \hline
        OR & \include{Recursos/Circuitos/ORcomNAND} \\ \hline
    \end{tabular}
...
\begin{figure}[H]
    \centering
    \include{Recursos/Circuitos/q3a}
    \vspace{-30pt}
...
\begin{figure}[H]
    \centering
    \include{Recursos/Circuitos/q3b}
    \vspace{-30pt}
...
\begin{figure}[H]
    \centering
    \include{Recursos/Circuitos/q3b2}
    \vspace{-30pt}
...
\begin{figure}[H]
    \centering
    \include{Recursos/Circuitos/q42}
    \vspace{-30pt}
