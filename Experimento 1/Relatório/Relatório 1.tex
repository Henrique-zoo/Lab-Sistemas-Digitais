...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\footnotesize{Laboratório de Sistemas Digitais - 2025/1 - Turma 07}}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{Imagens/circ1a.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{Imagens/circ1b.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{Imagens/circ3a.png}
