...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.35\textwidth]{Imagens/Meio Somador.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{Imagens/SomadorCompletoInterno.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.3\textwidth]{Imagens/multiplexador.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{Imagens/MultiplexadorInterno.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{Imagens/CompileModelSim.png}
